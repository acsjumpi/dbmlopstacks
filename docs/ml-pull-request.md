...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops_test-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-8951192101041839.19.azuredatabricks.net/explore/data/models/staging/mlops_test/mlops_test-model)
* [Prod model in UC](https://adb-8951192101041839.19.azuredatabricks.net/explore/data/models/prod/mlops_test/mlops_test-model)
. 
