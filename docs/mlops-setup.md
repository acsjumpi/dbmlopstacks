...
git add README.md docs .gitignore mlops_test/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-8951192101041839.19.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-8951192101041839.19.azuredatabricks.net#setting/accounts). If
...
If you want to use different catalog names, please update the target names declared in the[mlops_test/databricks.yml](../mlops_test/databricks.yml) file.
...
Follow the instructions in [mlops_test/resources/README.md](../mlops_test/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../mlops_test/resources/README.md)  to propose, test, and deploy
